...
async def evaluate(client_count):
    ...
    async def clean_up():
        await replica_instance.pkill("unreplicated")
    ...
    try:
        await evaluate_internal(replica_instance, client_instances)
    except:
...
async def evaluate_internal(replica_instance, client_instances):
    ...
    await replica_instance.tmux_interrupt("unreplicated")
